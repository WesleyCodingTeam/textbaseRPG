...
public class Items extends Inventory{
    ...
    ID4001.addAll(Arrays.asList("4001","Stone", "Quest", "1","some random price"));
    ArrayList<String> ID4002 = new ArrayList<String>();
    ID4002.addAll(Arrays.asList("4002","Wood", "Quest", "1","some random price"));
    ArrayList<String> ID4003 = new ArrayList<String>();
    ID4003.addAll(Arrays.asList("4003","Wolf fur", "Monster Loot", "1","some random price"));
