...
public class ItemGen{
    ...
    ID1001.addAll(Arrays.asList("Basic Sword", "Normal", "10", "100", "0","1","Just a normal sword"));
    ArrayList<String> ID1002 = new ArrayList<String>();
    ID1002.addAll(Arrays.asList("Basic Wand", "Normal", "10", "100", "0","1","Just a normal wand"));
    ArrayList<String> ID1003 = new ArrayList<String>();
    ID1003.addAll(Arrays.asList("Basic Knife", "Normal", "10", "100", "0","1","Just a normal knife"));
